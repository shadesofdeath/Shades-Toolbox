...
echo                 ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
echo.
echo                              Verison: %version%   User %username% - Date %date%                 
echo.
...
echo      ╠═══╦═════════════════════════════╠═══╣═════════════════════════════════╠═══╣═════════════════════════════════╠═══╣═════════════════════════════════╣
echo      ║ 6 ║ Zoom                        ║ 21║ GIMP                            ║ 36║ WinRAR                          ║ 51║ InternetDownloadManager         ║
echo      ║ 7 ║ Discord                     ║ 22║ IrfanView8                      ║ 37║ 7zip                            ║ 52║ Xtreme Download Manager         ║
echo      ║ 8 ║ Skype                       ║ 23║ ShareX                          ║ 38║ IZArc                           ║ 53║ JDownloader                     ║
echo      ║ 9 ║ WhatsApp                    ║ 24║ MyPaint                         ║ 39║ Peazip                          ║ 54║ FreeDownloadManager             ║
echo      ║ 10║ Telegram                    ║ 25║ Blender                         ║ 40║ Bandizip                        ║ 55║ NeatDownloadManager             ║
echo      ╠═══╩═════════════════════════════╠═══╣═════════════════════════════════╠═══╣═════════════════════════════════╣═══╣═════════════════════════════════╣
...
echo      ║ 14║ Handbrake                   ║ 29║ SUPERAntiSpyware                ║ 44║ OneDrive                        ║ 59║ BiglyBT                         ║
...
chcp 65001 >nul
echo =======================================
echo  Shades Automatic Windows Activator
echo =======================================
echo.
@echo off
...
cls
echo ================================
echo SHADES WİNDOWS 10/11 ACTİVATOR
echo ================================
echo.
